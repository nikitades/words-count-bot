 ...
 */
final class Version20190828060140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE word_used_times ADD word_id INT NOT NULL, DROP word_text, CHANGE telegram_id chat_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX unique_used_times_counter ON word_used_times');
        $this->addSql('ALTER TABLE word_used_times ADD telegram_id INT NOT NULL, ADD word_text VARCHAR(500) NOT NULL COLLATE utf8mb4_unicode_ci, DROP chat_id, DROP word_id');
